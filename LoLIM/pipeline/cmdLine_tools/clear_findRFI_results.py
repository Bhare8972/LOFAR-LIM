...
if __name__ == "__main__":
    print('program clear_findRFI_results')


    parser = argparse.ArgumentParser(description='Delete RFI data for all or one station. Need to run this if want to redo results.')
    ...
    output_files = [ f for f in os.listdir(outputFolder) if os.path.isfile(os.path.join(outputFolder, f)) and f.endswith('_advFindRFI.json') ]
