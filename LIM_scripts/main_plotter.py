...
#    data = read_PSE_timeID("D20170929T202255.000Z", "allPSE_runA") ## we read PSE from analysis "allPSE_new3" of flash that has timeID of "D20160712T173455.100Z"
...
#    PSE_dataset = DataSet_simplePointSources(PSE_list, markers=['s', 'D'], marker_size=5, color_mode="time", name="PSE", cmap=cmap)
#    plotter.add_dataset( PSE_dataset )
...
#    
#    from LoLIM.interferometry import read_interferometric_PSE_threeStage as R_IPSE_3S
#    timeID = "D20170929T202255.000Z"
##    input_folder = "interferometry_out4_threeStage"
##    input_folder = "interferometry_out4_threeStage_correctTraces"
##    input_folder = "interferometry_out4_threeStage_HF"
##    input_folder = "interferometry_out4_threeStage_HFS3small"
##    input_folder = "interferometry_out4_threeStage_correct"
##    input_folder = "interferometry_out4_threeStage_RMS"
##    input_folder = "interferometry_out4_threeStage_highCut"
#    input_folder = "interferometry_out4_threeStage_RMSCut"
#    
#    processed_data_folder = processed_data_dir(timeID)
#    data_dir = processed_data_folder + "/" + input_folder
#    
...
#    plotter.show()
#    
#    interferometry_header, IPSE = R_IPSE_3S.load_interferometric_PSE( data_dir, blocks_to_open=[338,339,340,341] )
#    
#    IPSE_dataset = DataSet_IPSE_threeStage(IPSE, loc_stage=2, marker='s', marker_size=5, color_mode="time", name="PSE", cmap=cmap)
#    plotter.add_dataset( IPSE_dataset )
